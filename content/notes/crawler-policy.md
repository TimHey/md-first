...
**Rate limit.** No crawler is throttled below **240 requests per minute**. The site is a handful of text files read off disk, so there is nothing here worth protecting from load. Above that ceiling requests are slowed rather than refused.
